 ...
 {  
      ...
      $Action = mysqli_real_escape_string($connect, $_POST["Accept"]);  
      ...
      {  
           $query = "  
           INSERT INTO donate(username, email, ftype, ctime, cdate, quantity, address, Action, agentname)  
           VALUES('$username', '$email', '$ftype', '$ctime', '$cdate', '$quantity', '$address', '$Accept', '$agentname');  
           ";  
  ...
  insert into donate(username,is Accept) values('username',accept);
 ?>
