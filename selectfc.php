 ...
 {  
      ...
      $query = "SELECT * FROM donate WHERE Id = '".$_POST["donate_Id"]."' && Action = 'accept'" ;  
      ...
      {  
           $output .= '  
                ...
                <tr>  
                     <td width="30%"><label>Agentname</label></td>  
                     <td width="70%">'.$row["agentname"].'</td>  
					 </tr>  
                <tr>  
                     <td width="30%"><label>FoodCollecting</label></td>  
                     <td width="70%">'.$row["foodcollect"].'</td>  
              <tr>  
